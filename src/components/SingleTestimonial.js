...
const SingleTestimonial = ({ userName, description, image }) => {
    return (
        <div
            className={`single_card mx-2 flex h-56 w-[clamp(260px,100%,500px)] flex-col gap-5 rounded-xl bg-white p-4 py-4 pl-5 shadow-2xl transition-all duration-500 hover:-translate-y-1 md:w-4/5 md:px-8 md:py-5`}
        >
