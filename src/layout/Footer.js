...
const Footer = () => {
    return (
        <div className="flex h-auto w-full flex-col items-center justify-between gap-6 bg-secondary-color py-5 px-4 font-open-sans-font text-lg font-semibold tracking-wider text-white md:flex-row md:px-28">
