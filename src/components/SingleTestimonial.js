...
const SingleTestimonial = ({ userName, description, image }) => {
    return (
        <div
            className={`single_card mx-2 flex h-[clamp(300px,100%,400px)] w-[clamp(260px,100%,500px)] flex-col gap-5 rounded-xl bg-white p-2 py-4 pl-3 shadow-2xl transition-all duration-300 md:w-4/5 md:px-8 md:py-5`}
        >
