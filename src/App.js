        ...
        <div className="h-auto">
            ...
            <SectionElement>
                <div className="flex h-full w-full flex-col items-center gap-16">
                    ...
                    <div className="all_cards flex h-auto w-full flex-row flex-wrap justify-center gap-10 bg-white p-10 px-10 lg:flex-nowrap">
                        ...
                        />
                        <SinglePricingCard pricingPlan={businessWebHosting} planAmount={249} planAmountWhenRenew={499} planName={"Businedd"} />
                    </div>
                </div>
            </SectionElement>
        </div>
